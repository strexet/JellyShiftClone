    ...
    public class ObstaclePart : MonoBehaviour
    {
        ...
        public void SwapMaterials()
        {
            ...
            if (materials.Length == 2)
            {
                ...
                {
                    materials[0].color = _data.NormalColor1;
                    materials[1].color = _data.NormalColor2;
                }
                else
                {
                    materials[0].color = _data.BreakthroughColor1;
                    materials[1].color = _data.BreakthroughColor2;
                }
